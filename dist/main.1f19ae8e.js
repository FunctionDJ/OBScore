...
(function (receivable) {
  // general
  receivable["connect"] = "connect";
  receivable["disconnect"] = "disconnect"; // OBScore general

  receivable["config"] = "config"; // scoreboard specific

  receivable["update"] = "update";
  receivable["notReady"] = "not ready";
})(receivable = exports.receivable || (exports.receivable = {}));

var emittable;

(function (emittable) {
  // OBScore general
  emittable["logDefault"] = "log default";
  emittable["introduce"] = "introduce";
  emittable["gibData"] = "gib data"; // scoreboard specific

  emittable["clientError"] = "client error";
})(emittable = exports.emittable || (exports.emittable = {}));
...
},{"./common":"../node_modules/debug/src/common.js","process":"../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../node_modules/socket.io-client/lib/url.js":[function(require,module,exports) {
...
},{"./url":"../node_modules/socket.io-client/lib/url.js","socket.io-parser":"../node_modules/socket.io-parser/index.js","./manager":"../node_modules/socket.io-client/lib/manager.js","debug":"../node_modules/debug/src/browser.js","./socket":"../node_modules/socket.io-client/lib/socket.js"}],"../OBScore.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(OBS, [{
    key: "logBase",
    value: function logBase(msg, style) {
      console.log("%c[OBScore.js] ".concat(msg), style);
    }
  }, {
    key: "log",
    ...
    value: function sendError(error) {
      if (_typeof(this.socket) !== "object") {
        throw new Error("Socket not available yet");
      }

      this.socket.emit(events_1.emittable.clientError, error.stack);
    }
  }, {
    key: "connect",
    value: function connect(server, callback) {
      var _this = this;

      var socket = socket_io_client_1.default(server);
      this.socket = socket;
      socket.on(events_1.receivable.connect, function (anything) {
        console.log(anything);

        _this.log("Connected to OBScore-Host");

        socket.emit(events_1.emittable.introduce, _this.name);
        socket.emit(events_1.emittable.gibData);

        if (callback) {
          callback();
        }
      });
      socket.on(events_1.receivable.disconnect, function () {
        return _this.logError("OBScore-Host Disconnected");
      });
      socket.on(events_1.receivable.update, function (scoreboard) {
        _this.log("Received update:");

        console.log(scoreboard);

        _this.onUpdate(scoreboard);

        _this.printedNotReady = false;
      });
      socket.on(events_1.receivable.notReady, function () {
        if (!_this.printedNotReady) {
          _this.log("Data is not ready, retrying every ".concat(_this.timeout, "ms..."));

          _this.printedNotReady = true;
        }
...
exports.default = OBS;
},{"./events":"../events.ts","socket.io-client":"../node_modules/socket.io-client/lib/index.js"}],"main.js":[function(require,module,exports) {
"use strict";

var _OBScore = _interopRequireDefault(require("../OBScore"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var elements = {
  players: [document.getElementById("player-0"), document.getElementById("player-1")],
  level: document.getElementById("level")
};

var stringifyPlayer = function stringifyPlayer(player) {
  if (!player.sponsor) {
    return player.tag;
  }

  return "".concat(player.sponsor, " | ").concat(player.tag);
};

var stringifyLevel = function stringifyLevel(level) {
  if (!level.bracket) {
    return "n/a";
  }
  ...
  if (level.number) {
    return "".concat(level.bracket.long, " ").concat(level.round.long, " ").concat(level.number);
  } else {
    return "".concat(level.bracket.long, " ").concat(level.round.long);
  }
};

document.addEventListener("DOMContentLoaded", function () {
  var obs = new _OBScore.default("something", function (data) {
    for (var playerIndex in data.players) {
      var player = data.players[playerIndex];
      elements.players[playerIndex].innerText = stringifyPlayer(player);
    }

    elements.level.innerText = stringifyLevel(data.level);
  });
  obs.connect("ws://localhost:3001");
});
},{"../OBScore":"../OBScore.ts"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
