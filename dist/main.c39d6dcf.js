...
exports.default = OBS;
},{"./events":"../events.ts","socket.io-client":"../node_modules/socket.io-client/lib/index.js"}],"main.ts":[function(require,module,exports) {
"use strict";
...
var OBScore_1 = __importDefault(require("../OBScore"));

var obs = new OBScore_1.default("something", function (data) {
  console.log(data);
});
